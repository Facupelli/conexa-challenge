...
import { StarWarsApiMovie } from 'src/modules/movies/interfaces/star-wars-api-movie.interface';
...
export const expectedMovie: Movie = {
  id: 1,
  createdAt: new Date(),
  updatedAt: new Date(),
  deletedAt: null,
...
export const starWarsApiMoves: StarWarsApiMovie[] = [
  {
    title: 'A New Hope',
    episode_id: 4,
    opening_crawl:
